...
# Conclusion 
In this post MCP basics are explained with a very simple example. In terms of practical implemenation there is more to be explored and understood especially security in MCP. In future posts regarding MCP we will explore with implemention the different MCP types - tools, resources and prompts, how to make it secure and in general about the precautions to be taken when using public MCP servers.
