...
# MCP in action
## Problem Statement
Your AI APP generates social media posts on latest tech happenings by fetching data from TechCrunch, Wired and Reuters. Build a MCP server which reads from these feeds and provides information to your AI APP which then summarises it and generates a catchy social media post ready to publish.
