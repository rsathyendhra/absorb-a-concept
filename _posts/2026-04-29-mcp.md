---
title: "Understanding MCP: What It Is, What It Isn't, and How to Build It"
date: 2026-06-18
category: Technical
---
...
Now you might wonder: "Doesn't this sound like a REST API?" The answer is nuanced. While both MCP and REST 
are remote procedure call (RPC) systems—asking a remote system to do something and getting results back—they 
serve fundamentally different purposes and are optimized for different scenarios. Let's explore these distinctions.
...
Check out the source code on [GitHub-mcp-calculator](https://github.com/rsathyendhra/mcp-calculator).
