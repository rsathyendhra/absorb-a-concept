...
```
#### 12. Navigate to http://127.0.0.1:8000 in your browser and create an entry using "POST"
...
#### 14. Update an entry using "PUT"

![update_cake]({{ "/assets/images/UpdateCakeEntry.png" | relative_url }})

#### 15. Quantity field updated

![updated_cake]({{ "/assets/images/UpdateCakeEntry.png" | relative_url }})

#### 16. Delete an entry using "DELETE"
